...
- `verify-docs.ts` verifies that `AGENTS.md` mentions every skill in `.agents/skills/` and every prompt template in `.pi/prompts/`. Run it after lint-staged and after substantial agent work.
